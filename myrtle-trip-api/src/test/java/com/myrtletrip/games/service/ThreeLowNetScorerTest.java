...
public class ThreeLowNetScorerTest {

    @Test
    void scoreRound_shouldUseBestThreeNetScoresPerHole() {
        ThreeLowNetScorer scorer = new ThreeLowNetScorer();

        RoundScoringData data = new RoundScoringData();
        data.setRoundId(102L);
        ...
        assertEquals(270, team1.getTotalNet());
        assertEquals(324, team2.getTotalNet());
        ...
        assertEquals(15, hole1.getNetScore());
    ...
    private TeamScoringData buildFourManTeam(Long teamId,
        ...
        players.add(buildPlayer(teamId * 10 + 1, "P1-" + teamId, player1Cycle));
        players.add(buildPlayer(teamId * 10 + 2, "P2-" + teamId, player2Cycle));
        players.add(buildPlayer(teamId * 10 + 3, "P3-" + teamId, player3Cycle));
        players.add(buildPlayer(teamId * 10 + 4, "P4-" + teamId, player4Cycle));
